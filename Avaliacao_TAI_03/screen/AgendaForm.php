...
<br>
   <h1 class="display-5" style= "text-align: center">Formulário da Agenda de Viagens</h1>
  <br>
    ...
    <input type="text" class="form-control" name="titulo" placeholder="Destino..." required value="<?php echo !empty($result->titulo) ? $result->titulo : "" ?>"/>
        </div>
